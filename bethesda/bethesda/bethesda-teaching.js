...
(function () {
    ...
    herodian: [
      {
        ...
        ref: "John 5:2–3",
        asv: "Now there is in Jerusalem by the sheep gate a pool, which is called in Hebrew Bethesda, having five porches. In these lay a multitude of them that were sick, blind, halt, withered.",
      ...
      },
      {
        ...
        where: "The way out, toward the probable Sheep Gate area",
        ref: "John 5:8–9",
        asv: "Jesus saith unto him, Arise, take up thy bed, and walk. And straightway the man was made whole, and took up his bed and walked.",
      ...
      },
      {
        ...
        ref: "John 5:3–4",
        asv: "Many ancient authorities insert, wholly or in part: waiting for the moving of the water: for an angel of the Lord went down at certain seasons into the pool, and troubled the water: whosoever then first after the troubling of the water stepped in was made whole, with whatsoever disease he was holden.",
        gloss: "This is the verse the earliest manuscripts do not have — see the note on the text below the essay. John 5:7 reports disturbed water, but neither the text nor the excavated remains establish the mechanism. Rainfall, runoff, controlled release, and seepage have been proposed; none is demonstrated."
      }
    ],
    aelia: [
      {
        ...
        ref: "Votive inscription, Greek — a find, not a text",
        asv: "Pompeia Lucilia dedicated this.",
  ...
  const TERMS = {
    iron: [
      ...
      { t: "channel cut into the bedrock", x: 55, y: 140, z: 0, label: "The rock-cut conduit, destination uncertain", tilt: 46, zoom: 1.5 },
    ...
    herodian: [
      ...
      { t: "water at a distance and below", x: 54, y: 91, z: -7, label: "The Lower Pool — the drop the man who had been ill faced", tilt: 26, zoom: 1.4 },
      { t: "the Antonia", x: 54, y: 140, z: 0, label: "South, toward the probable Antonia/Temple area", tilt: 44, zoom: 1.3 }
    ],
    aelia: [
  ...
  const NOTES = {
    herodian: {
      ...
      body: [
        ...
        "The archaeology gives that custom a setting. The eastern side of the site is a row of small basins cut into the rock, separate from the great reservoirs. John 5:7 reports disturbed water, but neither the text nor the excavated remains establish the mechanism — rainfall, runoff, controlled release, and seepage have all been proposed, and none is demonstrated. A place where water moved unpredictably, in a spot people already came to for healing, is enough to produce the practice John describes without any explanation at all.",
  ...
  const TAKEAWAY = {
    herodian: {
      ...
      point: "The man describes being unable to reach the disturbed water before another person. John portrays Jesus healing him without requiring access to the pool. The narrative does not establish how the site normally operated or why the man had remained ill for thirty-eight years — it gives us his account of his own situation, and Jesus's response to it. When Jesus arrives, he does not fix the man's access to the water. He does not carry him down, or hold the crowd back, or wait for the season. He ignores the pool entirely and speaks. John does not say the man's disability was caused by personal sin; read John 5:14 alongside John 9:1–3, and avoid turning either healing narrative into a judgment about disabled people or a promise that faith guarantees a cure.",
      questions: [
        "Look at the model of the Lower Pool from a low angle. Roughly thirteen metres of rock, and one stair in the corner. What does that drop suggest about reaching the water quickly — and what does it leave unanswered about how access actually worked?",
        ...
        "Roman-period votive evidence securely attests healing devotion at the later sanctuary. Whether it continued an earlier first-century practice at the same installations remains disputed. Why might a place keep drawing people seeking healing across changes in religion and rule, whether or not the practice was continuous?",
  ...
  const STRATA = [
    ...
    { top: 0, bot: -1.6, era: "1192 – 1856", name: "Ottoman and Mamluk fill: houses, waste ground (Saladin's 1187 conquest preceded the 1192 madrasa endowment)", cat: "islamic" },
