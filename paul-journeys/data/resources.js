/* Background resources for each study week, from Taylor Halverson's
...
1: { date: "Jan 3, 2027", items: [
  ...
  V("Matthew 1 — video insights with Taylor & Tyler", yt("UuJsSkJ_h0w")),
  V("Luke 1 — video insights with Taylor & Tyler", yt("5OoGQw2RJ94")),
...
2: { date: "Jan 10, 2027", items: [
  V("Luke 2; Matthew 2 — video insights", yt("pN39tVJBRhM")),
...
3: { date: "Jan 17, 2027", items: [
  ...
  ECHOES,
  V("John 1 — video insights", yt("sKSii1kywBY")),
...
4: { date: "Jan 24, 2027", items: [
  ...
  V("Matthew 3; Mark 1; Luke 3 — video insights", yt("sT6EAaqF7w0")),
...
5: { date: "Jan 31, 2027", items: [
  V("Matthew 4; Luke 4–5 — video insights", yt("HQi9JEOwUzw")),
...
6: { date: "Feb 7, 2027", items: [
  ...
  V("John 2–4 — video insights", yt("jtR7-caLLwg")),
...
7: { date: "Feb 14, 2027", items: [
  V("Matthew 5; Luke 6 — video insights", yt("9ZwGt2uEBXE")),
...
8: { date: "Feb 21, 2027", items: [
  V("Matthew 6–7 — video insights", yt("nHdrCEJRDbs")),
...
9: { date: "Feb 28, 2027", items: [
  V("Matthew 8; Mark 2–4; Luke 7 — video insights", yt("o8b1qz_pQYk")),
...
10: { date: "Mar 7, 2027", items: [
  V("Matthew 9–10; Mark 5; Luke 9 — video insights", yt("2QHXbIkLUw0")),
...
11: { date: "Mar 14, 2027", items: [
  C("How Teachers Teach Others to Find Literary Echoes in Scripture", ins("how-teachers-teach-others-to-find-literary-echoes-in-scripture")),
  V("Matthew 11–12; Luke 11 — video insights", yt("fTTmGLHpEwg")),
...
12: { date: "Mar 21, 2027", items: [
  V("Matthew 13; Luke 8; 13 — video insights", yt("eIszLljmx_4")),
...
13: { date: "Mar 28, 2027", items: [
  V("Easter — video insights", yt("b1iRVD7Mv5o")),
...
14: { date: "Apr 4, 2027", items: [
  V("Matthew 14; Mark 6; John 5–6 — video insights", yt("_ye8ByOk6XM")),
...
15: { date: "Apr 11, 2027", items: [
  V("Matthew 15–17; Mark 7–9 — video insights", yt("T-hr-CDP67o")),
...
16: { date: "Apr 18, 2027", items: [
  V("Matthew 18; Luke 10 — video insights", yt("3wFVxsb5Q5M")),
...
17: { date: "Apr 25, 2027", items: [
  V("John 7–10 — video insights", yt("163tvf70ZAc")),
...
18: { date: "May 2, 2027", items: [
  V("Luke 12–17; John 11 — video insights", yt("a3gpmKAxehM")),
...
19: { date: "May 9, 2027", items: [
  V("Matthew 19–20; Mark 10; Luke 18 — video insights", yt("YPJbJeVfa0g")),
...
20: { date: "May 16, 2027", items: [
  ...
  V("Matthew 21–23; Mark 11; Luke 19–20; John 12 — video insights", yt("ZPkJNaF-Z_s")),
...
21: { date: "May 23, 2027", items: [
  V("JS—Matthew 1; Matthew 24–25; Mark 12–13; Luke 21 — video insights", yt("rGZ6yKqO__E")),
...
22: { date: "May 30, 2027", items: [
  V("Matthew 26; Mark 14; John 13 — video insights", yt("laFgEAY0HPg")),
...
23: { date: "Jun 6, 2027", items: [
  ...
  V("John 14–17 — video insights", yt("IUccqK7-X1g")),
...
24: { date: "Jun 13, 2027", items: [
  ...
  V("Luke 22; John 18 — video insights", yt("PUnlXbWs-98")),
...
25: { date: "Jun 20, 2027", items: [
  V("Matthew 27; Mark 15; Luke 23; John 19 — video insights", yt("GcqjIt8VppY")),
...
26: { date: "Jun 27, 2027", items: [
  V("Matthew 28; Mark 16; Luke 24; John 20–21 — video insights", yt("MPdAUnxbt_4")),
  WOUNDABLE,
...
27: { date: "Jul 4, 2027", items: [
  ECHOES, V("Acts 1–5 — video insights", yt("KgyG7D8OiWY")),
...
28: { date: "Jul 11, 2027", items: [
  V("Acts 6–9 — video insights", yt("RjDcUxVBiJ8")),
...
29: { date: "Jul 18, 2027", items: [
  V("Acts 10–15 — video insights", yt("jw8eSlbSf0w")),
...
30: { date: "Jul 25, 2027", items: [
  V("Acts 16–21 — video insights", yt("jbBJGDC1mGw")),
...
31: { date: "Aug 1, 2027", items: [
  V("Acts 22–28 — video insights", yt("dh8ku0HErgs")),
...
32: { date: "Aug 8, 2027", items: [
  V("Romans 1–6 — video insights", yt("eYEkphybteo")),
...
33: { date: "Aug 15, 2027", items: [
  ...
  V("Romans 7–16 — video insights", yt("fEV1ZB_H0H4")),
...
34: { date: "Aug 22, 2027", items: [
  V("1 Corinthians 1–7 — video insights", yt("BsRPPAwKrYk")),
...
35: { date: "Aug 29, 2027", items: [
  V("1 Corinthians 8–13 — video insights", yt("UD5-cqQM8Uk")),
...
36: { date: "Sep 5, 2027", items: [
  V("1 Corinthians 14–16 — video insights", yt("_AZUGvrDWAw")),
...
37: { date: "Sep 12, 2027", items: [
  V("2 Corinthians 1–7 — video insights", yt("fCya5XVlg-k")),
...
38: { date: "Sep 19, 2027", items: [
  V("2 Corinthians 8–13 — video insights", yt("dZM9ZLBW-2g")),
...
39: { date: "Sep 26, 2027", items: [
  V("Galatians — video insights", yt("HShhGfq0Nwc")),
...
40: { date: "Oct 3, 2027", items: [
  V("Ephesians — video insights", yt("C8Uvc8BCz6Q")),
...
41: { date: "Oct 10, 2027", items: [
  V("Philippians; Colossians — video insights", yt("g3mspSYyMBY")),
...
42: { date: "Oct 17, 2027", items: [
  V("1 and 2 Thessalonians — video insights", yt("J8ep4_7qJPU")),
...
43: { date: "Oct 24, 2027", items: [
  V("1 and 2 Timothy; Titus; Philemon — video insights", yt("p9G46wWUcr8")),
...
44: { date: "Oct 31, 2027", items: [
  V("Hebrews 1–6 — video insights", yt("Z_Qtf-HCtzU")),
...
45: { date: "Nov 7, 2027", items: [
  ...
  V("Hebrews 7–13 — video insights", yt("Ua-eKjBJcZA")),
  WOUNDABLE, FEEDBACK,
...
46: { date: "Nov 14, 2027", items: [
  ...
  V("James — video insights", yt("A_E864MTazQ")),
...
47: { date: "Nov 21, 2027", items: [
  V("1 and 2 Peter — video insights", yt("iBCA-WnU8Pc")),
...
48: { date: "Nov 28, 2027", items: [
  V("1–3 John; Jude — video insights", yt("WQ_ATjHlhus")),
...
49: { date: "Dec 5, 2027", items: [
  V("Revelation 1–5 — video insights", yt("YKH-lIWsEXg")),
...
50: { date: "Dec 12, 2027", items: [
  V("Revelation 6–14 — video insights", yt("_x2EQJPi2L0")),
...
51: { date: "Dec 19, 2027", items: [
  V("Revelation 15–22 — video insights", yt("b08Z9KXm3CI")),
...
52: { date: "Dec 26, 2027", items: [
  V("Christmas — video insights", yt("UVKx9yH7LH8")),
