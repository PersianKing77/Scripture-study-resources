...
window.PAUL_JOURNEYS = [
{
  ...
  stops: [
    ...
    { place: "arabia", date: "c. AD 34–36 — 'three years'", ref: "Galatians 1:17", mode: "land", note: "Probably Nabataean territory; his destination, route, and purpose there are not stated. This marker is an illustrative region, not a located stop." },
    ...
    { place: "tarsus", date: "c. AD 37–45 — the silent years", ref: "Acts 9:30; Galatians 1:21", mode: "unknown", note: "Acts 9:30 says Paul was sent to Tarsus; it does not record the route or mode of travel." },
...
},
{
  ...
  summary: "Not a mission but a hearing. Men from Judea taught the Antioch Gentiles that they must be circumcised; Paul and Barnabas were sent up to settle it. The Council's letter — abstain from idol-meat, blood, things strangled, and fornication, and no more — is delivered by Paul and his companions to churches on the next journey (Acts 15:19–29; 16:4); how much weight it carried in Paul's later letters is debated (compare 1 Corinthians 8–10; Romans 14).",
  note: "This atlas follows the common identification of Galatians 2:1–10 with Acts 15; an alternative identifies Galatians 2 with the earlier famine visit of Acts 11:27–30, which would change the sequence and date.",
...
},
{
  ...
  stops: [
    ...
    { place: "assos", date: "AD 57 — Paul walks over the headland alone", ref: "Acts 20:13", mode: "land", km: 40, note: "Often quoted as 20 Roman miles (c. 40 km by the ground route); Acts says only that Paul went overland while the others sailed around the headland — it does not state elapsed time." },
    ...
    { place: "samos", date: "AD 57 — they passed Samos", ref: "Acts 20:15", mode: "sea", km: 100, note: "The Byzantine/Received Text tradition adds an overnight stop at Trogyllium here; this reading is absent from the modern critical text (see textual variant note)." },
    ...
    { place: "tyre", date: "AD 57 — seven days; farewell prayer on the beach", ref: "Acts 21:3–6", mode: "sea", km: 700, note: "Open-sea passage south of Cyprus, c. 700 km in about five days. Acts 21:2 identifies a ship crossing to Phoenicia but does not record its cargo or vessel class; 'Alexandrian grain ship' applies only to the later Myra-to-Italy voyage (Acts 27:6, 38)." },
...
},
{
  ...
  stops: [
    ...
    { place: "fairHavens", date: "October AD 59 — Paul's warning set aside", ref: "Acts 27:8–13", mode: "sea", km: 300, note: "Under the lee of Crete past Cape Salmone. The Fast (Day of Atonement) was already past — the sailing season was effectively shut." },
...
},
{
  ...
  summary: "Acts ends with Paul under house arrest and does not report the outcome. Some reconstructions infer release and later travel, especially if the Pastoral Epistles preserve Paul's subsequent movements; other scholars do not reconstruct a second career. The Pastoral Epistles presuppose travels that fit nowhere in Acts — Crete, Nicopolis, Miletus, Troas — and Clement of Rome writes within a generation that Paul reached 'the limit of the west'. Every location in this layer is proposed rather than narrated as a continuous itinerary; it is shown dashed throughout.",
