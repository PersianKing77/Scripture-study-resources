...
(function () {
  var P = [
    { id: 'chalco', n: 'Chalcolithic & Early Bronze', span: 'c. 4500–2300 BC', y0: -4500, y1: -2300, c: '#93b3cc' },
    { id: 'mb2', n: 'Middle Bronze II', span: 'c. 1800 BC', y0: -1900, y1: -1550, c: '#4fb0a3' },
    { id: 'lb', n: 'Late Bronze — Canaanite City-State', span: 'c. 1550–1200 BC', y0: -1550, y1: -1200, c: '#96bb62' },
    { id: 'ir2a', n: 'Iron Age IIA', span: 'c. 1000–800 BC', y0: -1000, y1: -800, c: '#dcbd4c' },
    { id: 'ir2bc', n: 'Iron Age IIB–C', span: 'c. 800–587 BC', y0: -800, y1: -587, c: '#e89a45' },
    { id: 'd586', n: 'Babylonian destruction', span: '587/586 BC', y0: -587, y1: -560, c: '#d4553c' },
    { id: 'pershas', n: 'Persian & Hasmonean', span: '538–63 BC', y0: -538, y1: -63, c: '#a596d4' },
    { id: 'herod', n: 'Herodian / late Second Temple', span: '37 BC – AD 70', y0: -37, y1: 70, c: '#f0c877' },
    { id: 'd70', n: 'Destruction & Aelia Capitolina', span: 'AD 70–324', y0: 70, y1: 324, c: '#bd5641' },
    { id: 'byz', n: 'Byzantine', span: 'AD 324–638', y0: 324, y1: 638, c: '#5aa6d4' },
    { id: 'islam', n: 'Early Islamic', span: 'AD 638–1099', y0: 638, y1: 1099, c: '#4fb289' },
    { id: 'medott', n: 'Medieval – Ottoman', span: 'AD 1099–1917', y0: 1099, y1: 1917, c: '#b8946c' },
  ...
  /* 2. Middle Bronze II --------------------------------------------------- */
  f({ id: 'mb-springtower', n: 'Spring Tower', per: 'mb2', spans: ['mb2', 'lb', 'ir2a', 'ir2bc'], cat: 'fort', conf: 'secure', d: 'M330 292 L398 292 L398 360 L330 360 Z', sd: 'M400 240 L452 240 L452 300 L400 300 Z', lbl: 1, lx: 404, ly: 300, la: 'start', slbl: 1, slx: 426, sly: 232, sla: 'middle', note: 'A tower of boulders up to 3 m across, walls c. 7 m thick, built directly over the spring. Excavated by Reich and Shukron. Traditionally dated to the Middle Bronze Age; radiocarbon evidence published in 2017 permits a late ninth-century BCE construction scenario, though the interpretation is contested — existence and scale are secure, the date is disputed.' });
  ...
  f({ id: 'warren-shaft', n: 'Warren\'s Shaft', per: 'ir2bc', spans: ['ir2bc', 'modern'], cat: 'water', conf: 'secure', d: 'M298 306 m-11 0 a11 11 0 1 0 22 0 a11 11 0 1 0 -22 0', sd: 'M362 208 L376 208 L382 284 L368 284 Z', lbl: 1, lx: 286, ly: 300, la: 'end', note: 'A natural karstic shaft, about 13 m deep, met by chance by the rock-cut passage. Older books had Joab climbing it to take the city for David (2 Samuel 5:8); Reich and Shukron showed the passage was not originally designed as a bucket-drawing installation at the shaft, substantially weakening the tsinnor identification — the Jebusites more plausibly reached their water through the fortified Spring Tower and rock-cut pool instead.' });
  ...
  f({ id: 'burnt-room', n: 'Burnt Room', per: 'ir2bc', spans: ['ir2bc', 'd586'], cat: 'domestic', conf: 'secure', d: 'M266 372 L296 368 L300 396 L270 400 Z', lbl: 1, lx: 310, ly: 388, la: 'start', note: 'Filled with charred wood, including imported furniture timber burnt in 586 BC.' });
  ...
  f({ id: 'lmlk', n: 'LMLK jar handles (find spots)', per: 'ir2bc', cat: 'find', conf: 'secure', lbl: 1, lx: 198, ly: 462, la: 'end', d: 'M254 452 l11 0 l0 11 l-11 0 z M282 460 l11 0 l0 11 l-11 0 z M238 476 l11 0 l0 11 l-11 0 z', note: 'Storage jars stamped "belonging to the king", linked to Hezekiah\'s preparations against Assyria.' });
  f({ id: 'ir-terrace-houses', n: 'Terrace houses on the eastern slope', per: 'ir2bc', cat: 'domestic', conf: 'secure', lbl: 1, lx: 330, ly: 500, la: 'start', d: 'M262 452 L292 448 L296 476 L266 480 Z M256 486 L288 482 L292 512 L260 516 Z M252 522 L282 518 L286 546 L254 550 Z', note: 'Dense housing stepped down the slope on artificial terraces, the densest Iron Age quarter yet found here.' });
  ...
  f({ id: 'arrowheads', n: 'Arrowheads (Scythian and local types)', per: 'd586', cat: 'find', conf: 'secure', d: 'M270 300 l9 0 l0 9 l-9 0 z M296 340 l9 0 l0 9 l-9 0 z M262 388 l9 0 l0 9 l-9 0 z M300 424 l9 0 l0 9 l-9 0 z', note: 'Bronze and iron arrowheads scattered in the burnt debris, widely associated with the Babylonian conquest of 587/586 BC — artifacts alone do not identify a specific attacker.' });
  ...
  f({ id: 'stamped-handles', n: 'Yehud and rhodian stamped handles', per: 'pershas', cat: 'find', conf: 'secure', la: 'end', d: 'M256 262 l10 0 l0 10 l-10 0 z M288 292 l10 0 l0 10 l-10 0 z', note: 'Administrative stamps naming the province of Yehud, plus imported wine-jar handles, are the clearest Persian-Hellenistic evidence.' });
  ...
  f({ id: 'pilgrim-road', n: 'Monumental stepped street (commonly interpreted as a pilgrimage route)', per: 'herod', spans: ['herod', 'd70'], cat: 'street', conf: 'secure', line: 1, sw: 12, d: 'M256 800 L266 700 L274 600 L282 500 L290 400 L298 300 L304 200 L306 118', sd: 'M896 316 L760 296 L620 268 L480 234 L360 202', lbl: 1, lx: 292, ly: 660, la: 'start', slbl: 1, slx: 600, sly: 254, sla: 'middle', note: 'A stepped street about 8 m wide, paved with large slabs. Excavated in sections over some 600 m from the pool towards the Temple Mount; existence and width are secure for excavated segments, and construction after AD 30/31 is secure for the excavated segments; the coins support construction during the governorship of Pontius Pilate. The continuous course drawn here includes reconstructed stretches, and its function as a pilgrimage route is an interpretation, not a measured fact.' });
  f({ id: 'drain', n: 'Drainage channel beneath the street', per: 'herod', spans: ['herod', 'd70', 'modern'], cat: 'water', conf: 'secure', line: 1, sw: 2.6, d: 'M252 800 L262 700 L270 600 L278 500 L286 400 L294 300 L300 200 L302 118', sd: 'M896 332 L760 312 L620 284 L480 250 L360 218', slbl: 1, slx: 600, sly: 300, sla: 'middle', note: 'A stone-roofed channel high enough to walk in. Josephus says refugees hid in the drains in AD 70, and cooking pots and coins were found inside.' });
  ...
  f({ id: 'byz-wall', n: 'Byzantine city wall around the ridge', per: 'byz', cat: 'fort', conf: 'probable', line: 1, sw: 4, d: 'M226 96 C266 190 300 320 316 460 C330 600 306 760 258 892 C216 866 194 740 182 600 C170 452 184 240 226 96 Z', lbl: 1, lx: 178, ly: 300, la: 'end', note: 'A southern wall commonly associated with fifth-century expansion enclosed much of the ridge again; its precise date, builder and full course remain debated, and the attribution to Eudocia rests on written sources rather than an inscription — traced by Bliss and Dickie and confirmed since.' });
  ...
  f({ id: 'quake749', n: 'Earthquake-collapse horizon (commonly dated AD 749)', per: 'islam', cat: 'destruction', conf: 'probable', d: 'M226 320 L300 312 L306 500 L232 508 Z', lbl: 1, lx: 316, ly: 424, la: 'start', note: 'Walls found lying flat in one direction, with vessels crushed on the floors beneath — commonly associated with the mid-eighth-century earthquake, often dated to 18 January AD 749.' });
  ...
  f({ id: 'area-g', n: 'Area G — Kenyon (1961–67) and Shiloh (1978–85)', per: 'modern', cat: 'excav', conf: 'secure', d: 'M244 210 L330 200 L340 470 L252 482 Z', lbl: 1, lx: 348, ly: 268, la: 'start', note: 'The deep cut through the eastern slope that exposed the Stepped Stone Structure, the Iron Age houses and the 586 BC destruction.' });
  ...
  f({ id: 'warren-tun', n: 'Warren\'s tunnels (1867)', per: 'modern', cat: 'excav', conf: 'secure', lbl: 1, lx: 218, ly: 306, la: 'end', line: 1, sw: 1.6, d: 'M298 306 L268 268 L250 226 M298 306 L332 292', note: 'Charles Warren mined horizontally into the slope, finding the shaft that carries his name.' });
