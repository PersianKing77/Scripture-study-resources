...
(function () {
  ...
  // --- Middle Bronze
  s('Spring Tower', 'Stone tower over the spring', 'A fortress built right on top of the spring to protect access to the water during threat or siege. Its walls are about 7 m thick — as thick as a room is wide. Existence and scale are secure; the construction date is disputed.');
  s('Spring Tower — walls c. 7 m thick', 'Stone tower over the spring', 'A fortress built right on top of the spring to protect access to the water during threat or siege. Its walls are about 7 m thick — as thick as a room is wide. Existence and scale are secure; the construction date is disputed.');
  ...
  s('Late Bronze burial finds, Kidron slope', 'Graves', 'Tombs holding pottery imported from Cyprus and Greece — evidence the town took part in long-distance exchange networks.');
  ...
  // --- 586 BC
  s('Destruction layer, Area G', 'The burnt layer', 'Up to a metre of ash, smashed pots and fallen stone — the city burning in 587/586 BC, frozen in the ground.');
  s('Destruction debris over the terraces', 'The burnt layer', 'Up to a metre of ash, smashed pots and fallen stone — the city burning in 587/586 BC, frozen in the ground.');
  s('Arrowheads (Scythian and local types)', 'Arrowheads', 'Arrowheads found mixed together in the ash of a destruction horizon widely linked to the Babylonian conquest of 587/586 BC.');
  ...
  s('Monumental stepped street (commonly interpreted as a pilgrimage route)', 'The stepped street', 'A stone-paved street 8 m wide, excavated in sections over about 600 m from the pool towards the Temple. Coins under the paving, including one from AD 30/31, show it was paved after that date and support construction under Pontius Pilate; unexcavated stretches are reconstructed, and its use as a pilgrimage route is an interpretation.');
  s('Monumental stepped street — 8 m wide, c. 600 m long', 'The stepped street', 'A stone-paved street 8 m wide, excavated in sections over about 600 m from the pool towards the Temple. Coins under the paving, including one from AD 30/31, show it was paved after that date and support construction under Pontius Pilate; unexcavated stretches are reconstructed, and its use as a pilgrimage route is an interpretation.');
  ...
  // --- AD 70
  s('Destruction debris over the street', 'Rubble on the street', 'Burnt beams and collapsed stone lying directly on the paving — the city destroyed in AD 70.');
  ...
  s('Byzantine city wall around the ridge', 'Wall around the ridge again', 'A wall commonly linked to the 5th-century Eudocia building program enclosed much of the ridge again.');
  ...
  s('Earthquake-collapse horizon (commonly dated AD 749)', 'Earthquake collapse', 'Walls found lying flat, all fallen the same way, with crushed pots underneath — commonly linked to the mid-eighth-century earthquake, often dated AD 749.');
  ...
  // --- Modern
  s('Area G — Kenyon (1961–67) and Shiloh (1978–85)', 'The main dig', 'The deep cut through the slope that exposed the giant stone structure, the Iron Age houses and the 587/586 BC burnt layer.');
  s('Givati Parking Lot excavation (2007– )', 'The car park dig', 'The biggest open excavation here, cutting through every layer from the Iron Age to the 8th century AD.');
  ...
  s('Monumental stepped street tunnel excavation (2013– )', 'Digging the street, underground', 'The Roman street is being dug out by tunnelling beneath the modern neighbourhood — the most argued-about method used here.');
  ...
  s('Collapse over the paving stones', 'Rubble on the street', 'Burnt beams and fallen stone lying straight on the paving — the city destroyed in AD 70.');
  ...
  s('City wall around the southern ridge', 'Wall around the ridge again', 'A wall commonly linked to the 5th-century Eudocia building program enclosed much of the ridge again.');
  ...
  s('Earthquake-collapse horizon (commonly dated AD 749)', 'Earthquake collapse', 'Walls found lying flat, all fallen the same way, with crushed pots beneath — commonly linked to the mid-eighth-century earthquake, often dated AD 749.');
  ...
  s('Area G excavation cut', 'The main dig', 'The deep cut through the slope that exposed the giant stone structure, the Iron Age houses and the 587/586 BC burnt layer.');
  ...
  var SCENE = {
    ...
    d70:     { one: 'Destroyed, then deliberately left out.', two: 'Rome burns the city in AD 70, then rebuilds it to the north and leaves this ridge outside the walls. Nothing is built here for 250 years.' },
    ...
    islam:   { one: 'Big new buildings, then an earthquake.', two: 'Large stone buildings go up under the Umayyads. In AD 749 an earthquake flattens them and nobody rebuilds at that scale.' },
