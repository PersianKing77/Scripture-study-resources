// Herodian Temple complex, c. AD 30. Meters, y-up. East = +x, north = +z.
...
export function buildTemple(opts = {}) {
  ...
  // the terrace of the chel, on the twelve steps' landing (now the west/high end, by the platform)
  crowd(22, 61.7, (a, b) => [66 - b * 6, -34 + a * 68, 3.15]);
