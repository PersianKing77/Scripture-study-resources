...
**Version:** 0.4.2-beta &nbsp;|&nbsp; **Build date:** 2026-09-16 &nbsp;|&nbsp; **Prepared by:** Claude Design, for Taylor Halverson, Ph.D.
...
## What changed in this build (round 3, UX pass)
- Consolidated the bottom toolbar into a single **Tools** menu next to About (Reading, Find, Map view, Navigate, More sections); **Study** (formerly "Weekly") is now a standalone header button.
- Added explicit close buttons to the Journeys and Study panels.
- Added **Parchment** and **Plain** basemap options alongside Satellite/Street map.
- Reorganized all 13 era essays to group wall/excavation/dating detail into an "Archaeological notes" section.
- Pinned the essay header while scrolling essay content.
